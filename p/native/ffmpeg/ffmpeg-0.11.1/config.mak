...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --cc=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc --cross-prefix=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi- --nm=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-nm --sysroot=C:/android-ndk/platforms/android-18/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -march=armv7-a -mtune=cortex-a8 -Wno-multichar -fno-exceptions -ID:/Project/p/jni/bzip2/ -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE' --enable-gpl --enable-version3 --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=C:/android-ndk/platforms/android-18/arch-arm/usr/lib -L C:/android-ndk/platforms/android-18/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog -L D:/Project/p/jni/bzip2' --enable-parsers --enable-decoders --enable-demuxers --enable-network --enable-protocols --enable-protocol=file --enable-swscale --enable-swresample --enable-avformat --enable-avcodec --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-devices --disable-avdevice --disable-postproc --disable-avfilter --disable-swscale-alpha --disable-bsfs --disable-encoders --disable-muxers --disable-indevs --disable-debug --disable-doc --disable-demuxer=srt --disable-demuxer=microdvd --disable-demuxer=jacosub --disable-decoder=ass --disable-decoder=srt --disable-decoder=microdvd --disable-decoder=jacosub --enable-bzlib --enable-zlib --enable-pic --enable-optimizations --disable-filters --arch=arm --cpu=armv7-a --enable-armv5te --enable-armv6 --enable-armvfp --enable-memalign-hack --enable-neon"
...
CC_IDENT=gcc 4.6 (GCC)
ARCH=arm
CC=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
CXX=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/binn/arm-linux-androideabi-g++
AS=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/binn/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=C:/android-ndk//toolchains/arm-linux-androideabi-4.6/prebuilt/windows/bin/arm-linux-androideabi-strip
CPPFLAGS= --sysroot=C:/android-ndk/platforms/android-18/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -march=armv7-a -mtune=cortex-a8 -Wno-multichar -fno-exceptions -ID:/Project/p/jni/bzip2/ -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -march=armv7-a -mtune=cortex-a8 -Wno-multichar -fno-exceptions -ID:/Project/p/jni/bzip2/ -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -march=armv7-a -fPIC
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -Wl,-rpath-link=C:/android-ndk/platforms/android-18/arch-arm/usr/lib -LC:/android-ndk/platforms/android-18/arch-arm/usr/lib/ -nostdlib -lc -lm -ldl -llog -LD:/Project/p/jni/bzip2/ --sysroot=C:/android-ndk/platforms/android-18/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
